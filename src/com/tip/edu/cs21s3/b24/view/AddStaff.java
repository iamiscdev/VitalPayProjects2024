...
public class AddStaff extends JFrame {
    ...
    public AddStaff() {
        ...
        String[] roles = { "Admin", "Nurse", "Doctor"}; // Adjust roles if necessary
        ...
        savedetails.addActionListener(e -> {
            ...
            if(db.addUser(generateUserId(selectedRole, 6), firstName, lastName, addressText, userNameText, passwordText, selectedRole)) {
                
                JOptionPane.showMessageDialog(this, "New staff added successfully", "Success", JOptionPane.INFORMATION_MESSAGE);
                this.setVisible(false);
                VitalPayAdmin.reloadTableData();
                
            } else {
            
                JOptionPane.showMessageDialog(this, "Adding staff unsuccessful", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private String generateUserId(String role, int length) {
        ...
        // Convert StringBuilder to String to int and return
        return sb.toString();
    }
